    ...
    <main className="flex flex-col items-center justify-center min-h-screen px-4 py-12 bg-gradient-to-r from-blue-500 to-green-300">
      <div className="bg-white border border-black rounded-xl shadow-md p-8 max-w-4xl w-full text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Starter Plan */}
          <div className="bg-gray-50 border border-black rounded-lg p-6 shadow hover:shadow-lg transition">
          ...
          {/* Pro Plan */}
          <div className="bg-gray-100 border border-black rounded-lg p-6 shadow hover:shadow-lg transition">
            ...
            <button className="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">Upgrade to Pro</button>
          </div>

          {/* Team Plan */}
          <div className="bg-gray-200 border border-black rounded-lg p-6 shadow hover:shadow-lg transition">
            ...
            <button className="bg-purple-500 text-white px-4 py-2 rounded hover:bg-purple-600">Contact Sales</button>
          </div>
        </div>
      </div>
    </main>
